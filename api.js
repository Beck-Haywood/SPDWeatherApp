...
// const key = '485c2a6b9e4f16c28d7e45232a65c68b'
const getWeatherData = async city => {
    // const data = await fetch('http://api.openweathermap.org/data/2.5/weather?q=Anchorage&appid=485c2a6b9e4f16c28d7e45232a65c68b&units=imperial')
